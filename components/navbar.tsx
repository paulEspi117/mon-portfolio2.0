    ...
    return (
        <nav>
            <ul className="flex space-x-6 justify-center p-4 bg-slate-950/50 backdrop-blur-md  ">
                <li>
                    <a href="#home" className="text-white hover:text-blue-400">Accueil</a>
                </li>
                <li>
                    <a href="#" onClick={() => document.getElementById("about")?.scrollIntoView({ behavior: "smooth" })} className="text-white hover:text-blue-400">À propos</a>
                </li>
                <li>
